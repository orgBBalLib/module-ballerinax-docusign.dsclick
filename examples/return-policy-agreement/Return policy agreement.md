...
Execute the following command to run the example. The script will create a return policy clickwrap, retrieve and update it, fetch user agreements, and then delete the clickwrap, printing the results to the console.
