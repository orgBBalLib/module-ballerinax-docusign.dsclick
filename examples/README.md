...
1. [Return policy agreement](https://github.com/ballerina-platform/module-ballerinax-docusign.dsclick/tree/main/examples/return-policy-agreement) - Integrate DocuSign Click to capture user consent for return policy agreements.

2. [Terms and conditions agreement](https://github.com/ballerina-platform/module-ballerinax-docusign.dsclick/tree/main/examples/terms-and-conditions-agreement) - Implement clickwrap agreements to obtain user acceptance of terms and conditions.
