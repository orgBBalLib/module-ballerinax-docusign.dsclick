...
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config =  {}, string serviceUrl = "https://www.demo.docusign.net/clickapi") returns error? {
    ...
    # eSignature Settings
    # + clickwrapId - The ID of the clickwrap
    # + version - The ID or number of the version
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
