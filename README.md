...
2. Ensure you have a DocuSign eSignature plan that includes Click (formerly known as DocuSign Click). Click functionality is available as an add-on or included in certain Business Pro and Enterprise plans. For development purposes, you can use a free [DocuSign Developer Account](https://developers.docusign.com/platform/account/).

### Step 2: Generate an API Access Token

1. Log in to your DocuSign Developer Account at [developers.docusign.com](https://developers.docusign.com/).

2. Navigate to the **Settings** page by clicking on your profile icon in the top right corner and selecting **My Apps & Keys**.

3. Under the **Apps and Keys** section, click **Add App and Integration Key** to create a new application.

4. Provide a name for your application and click **Create App**.

5. Copy the **Integration Key** (Client ID) that is generated for your application.

6. To generate an access token for testing, scroll down to the **Authentication** section and configure your preferred authentication method (Authorization Code Grant or JWT Grant).

7. For quick testing, you can use the **Get Access Token** option in the DocuSign Developer Center's API Explorer to obtain a temporary access token.
