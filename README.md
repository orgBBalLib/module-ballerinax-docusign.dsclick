...
[DocuSign](https://www.docusign.com/) is a cloud-based electronic signature and agreement management platform that enables organizations to securely send, sign, and manage documents digitally, accelerating business processes and eliminating paper-based workflows.
...
To use the DocuSign Click connector, you must have access to the DocuSign Click API through a [DocuSign developer account](https://developers.docusign.com/) and obtain an API access token. If you do not have a DocuSign account, you can sign up for one [here](https://go.docusign.com/o/sandbox/).

### Step 1: Create a DocuSign Account

1. Navigate to the [DocuSign Developer Center](https://developers.docusign.com/) and create a free developer sandbox account, or log in if you already have one.

2. Note that DocuSign Click is available as an add-on feature. For production use, ensure your DocuSign plan includes Click (Clickwrap) functionality, which is typically available with eSignature Business Pro or Enterprise plans.

### Step 2: Generate an API Access Token

1. Log in to your DocuSign developer account at [developers.docusign.com](https://developers.docusign.com/).

2. Navigate to the **Settings** page by clicking on your profile icon in the top right corner, then select **Apps and Keys**.

3. Under the **My Apps & Keys** section, click **Add App and Integration Key** to create a new application.

4. Provide an app name and configure the required settings for your integration, including the authentication method (JWT or Authorization Code Grant).

5. Copy the **Integration Key** (Client ID) generated for your application.

6. For quick testing, you can generate a temporary access token by navigating to **API & Keys** and clicking **Generate Access Token** under the **Authentication** section.
