...
[DocuSign](https://www.docusign.com/) is a leading electronic signature and agreement cloud platform that enables organizations to automate the agreement process, allowing users to sign, send, and manage documents digitally from anywhere.
...
5. Copy the **Integration Key** (also known as the Client ID) for your application.

6. To generate an access token for testing, navigate to the **API and Keys** section and use the **Generate Access Token** option, or configure OAuth authentication (Authorization Code Grant or JWT Grant) for production use.
        ...
        documents: [
            {
                ...
                documentHtml: "<html><body><h1>Terms and Conditions</h1><p>Please read and accept our terms.</p></body></html>",
                'order: 1
            }
        ],
        displaySettings: {
...
1. [Return policy agreement](https://github.com/ballerina-platform/module-ballerinax-docusign.dsclick/tree/main/examples/return-policy-agreement) - Demonstrates how to create and manage return policy agreements using the Ballerina connector for DocuSign Click.
